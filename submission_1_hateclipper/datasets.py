...
class CustomCollator(object):
    ...
    def __call__(self, batch):
        ...
        if self.args.dataset in ['fb-memes', 'tamil']:
            batch_new['labels'] = labels
        if self.args.dataset in ['fb-memes']:
...
def load_dataset(args, split):
    if args.dataset == 'tamil':
        ...
        dataset = HatefulMemesDataset(root_folder='data/hateful_memes', image_folder='data/hateful_memes/images', split=split, labels=args.labels, image_size=args.image_size)
